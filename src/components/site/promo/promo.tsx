          ...
          <div className="carousel-inner">
              ...
              <div className="row">
                ...
                <div className="col-md-4 mb-4">
                  <div className="card shadow-sm border-0 rounded">
                    <img src="https://via.placeholder.com/400x250.png" className="card-img-top" alt="Promoção 1" />
                ...
                <div className="col-md-4 mb-4">
                  <div className="card shadow-sm border-0 rounded">
                    <img src="https://via.placeholder.com/400x250.png" className="card-img-top" alt="Promoção 2" />
                    <div className="card-body">
                ...
                <div className="col-md-4 mb-4">
                  <div className="card shadow-sm border-0 rounded">
                    <img src="https://via.placeholder.com/400x250.png" className="card-img-top" alt="Promoção 3" />
                    <div className="card-body">
            ...
            <div className="carousel-item">
              <div className="row">
                ...
                <div className="col-md-4 mb-4">
                  <div className="card shadow-sm border-0 rounded">
                    <img src="https://via.placeholder.com/400x250.png" className="card-img-top" alt="Promoção 4" />
                    <div className="card-body">
                ...
                <div className="col-md-4 mb-4">
                  <div className="card shadow-sm border-0 rounded">
                    <img src="https://via.placeholder.com/400x250.png" className="card-img-top" alt="Promoção 5" />
                    <div className="card-body">
                ...
                <div className="col-md-4 mb-4">
                  <div className="card shadow-sm border-0 rounded">
                    <img src="https://via.placeholder.com/400x250.png" className="card-img-top" alt="Promoção 6" />
                    <div className="card-body">
